...
export class InspectionModeManager {
    ...
    private addEventListeners(): void {
        try {
            ...
            console.warn('InspectionModeManager: Failed to add event listeners', error);
        }
    }
    ...
    private removeEventListeners(): void {
        try {
            ...
            // Handle DOM errors gracefully
            console.warn('InspectionModeManager: Failed to remove event listeners', error);
        }
    }
    ...
    private handleClick(event: Event): void {
        if (this.isActive) {
            try {
                ...
                console.warn('InspectionModeManager: Failed to prevent click event', error);
            }
        }
    }
    ...
    private handleSubmit(event: Event): void {
        if (this.isActive) {
            try {
                ...
                // Handle event prevention errors gracefully
                console.warn('InspectionModeManager: Failed to prevent submit event', error);
            }
        }
    }
    ...
    private notifyServiceWorker(messageType: string): void {
        try {
            ...
            console.warn('InspectionModeManager: Failed to notify service worker', error);
        }
    }
